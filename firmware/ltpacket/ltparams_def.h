...
LTDEF(0xb, LTPARAMS_WHEEL_RADIUS, LTPARAMS_TYPE_FLOAT, f, 1e-3)
LTDEF(0xc, LTPARAMS_WHEEL_DISTANCE, LTPARAMS_TYPE_FLOAT, f, 8e-2)
...
LTDEF(0x15, LTPARAMS_CONTROL_DEBUG_PUBLISH_PERIOD, LTPARAMS_TYPE_UINT32, ui, 100000)
