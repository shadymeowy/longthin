...
LTDEF(0x13, LTPARAMS_MOTOR_PWM_REFRESH_PERIOD, LTPARAMS_TYPE_UINT32, ui, 33333)
...
LTDEF(0x37, LTPARAMS_PARKING_ESTIMATOR_XY_LIMIT, LTPARAMS_TYPE_FLOAT, f, 1.1)
LTDEF(0x38, LTPARAMS_PARKING_ESTIMATOR_APPROACH_D, LTPARAMS_TYPE_FLOAT, f, 0.7)
...
LTDEF(0x3f, LTPARAMS_PLANNER_ALIGNMENT_THRESHOLD, LTPARAMS_TYPE_FLOAT, f, 0.5)
LTDEF(0x40, LTPARAMS_ADC_FRONT_MULTIPLIER, LTPARAMS_TYPE_FLOAT, f, 0.0096565389)
LTDEF(0x41, LTPARAMS_ADC_REAR_MULTIPLIER, LTPARAMS_TYPE_FLOAT, f, 0.06594827586)
LTDEF(0x42, LTPARAMS_ADC_PUBLISH_PERIOD, LTPARAMS_TYPE_UINT32, ui, 1000000)