...
LTDEF(0x8, LTPARAMS_PARKING_KP, LTPARAMS_TYPE_FLOAT, f, 2.5)
LTDEF(0x9, LTPARAMS_PARKING_KI, LTPARAMS_TYPE_FLOAT, f, 1e-05)
LTDEF(0xa, LTPARAMS_PARKING_KD, LTPARAMS_TYPE_FLOAT, f, 5.0)
LTDEF(0xb, LTPARAMS_PARKING_KI_LIMIT, LTPARAMS_TYPE_FLOAT, f, 100.0)
...
LTDEF(0x32, LTPARAMS_LANE_LOOKAHEAD, LTPARAMS_TYPE_FLOAT, f, -175.0)
