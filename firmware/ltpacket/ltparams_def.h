...
LTDEF(0x8, LTPARAMS_PARKING_KP, LTPARAMS_TYPE_FLOAT, f, 1.0)
LTDEF(0x9, LTPARAMS_PARKING_KI, LTPARAMS_TYPE_FLOAT, f, 0.0)
LTDEF(0xa, LTPARAMS_PARKING_KD, LTPARAMS_TYPE_FLOAT, f, 3.0)
