...
LTDEF(0x19, LTPARAMS_MAG_CALIB_B0, LTPARAMS_TYPE_FLOAT, f, -0.01409842)
LTDEF(0x1a, LTPARAMS_MAG_CALIB_B1, LTPARAMS_TYPE_FLOAT, f, -0.01651878)
LTDEF(0x1b, LTPARAMS_MAG_CALIB_B2, LTPARAMS_TYPE_FLOAT, f, -0.15467174)
LTDEF(0x1c, LTPARAMS_MAG_CALIB_M00, LTPARAMS_TYPE_FLOAT, f, 2248.0437349117365)
LTDEF(0x1d, LTPARAMS_MAG_CALIB_M01, LTPARAMS_TYPE_FLOAT, f, -9.820466585653632)
LTDEF(0x1e, LTPARAMS_MAG_CALIB_M02, LTPARAMS_TYPE_FLOAT, f, 83.5181286985458)
LTDEF(0x1f, LTPARAMS_MAG_CALIB_M10, LTPARAMS_TYPE_FLOAT, f, -9.820466585653618)
LTDEF(0x20, LTPARAMS_MAG_CALIB_M11, LTPARAMS_TYPE_FLOAT, f, 2323.575656987126)
LTDEF(0x21, LTPARAMS_MAG_CALIB_M12, LTPARAMS_TYPE_FLOAT, f, -10.094511360510472)
LTDEF(0x22, LTPARAMS_MAG_CALIB_M20, LTPARAMS_TYPE_FLOAT, f, 83.51812869854605)
LTDEF(0x23, LTPARAMS_MAG_CALIB_M21, LTPARAMS_TYPE_FLOAT, f, -10.0945113605105)
LTDEF(0x24, LTPARAMS_MAG_CALIB_M22, LTPARAMS_TYPE_FLOAT, f, 2721.9289350440895)
LTDEF(0x25, LTPARAMS_ACCEL_CALIB_B0, LTPARAMS_TYPE_FLOAT, f, 0.0)
LTDEF(0x26, LTPARAMS_ACCEL_CALIB_B1, LTPARAMS_TYPE_FLOAT, f, 0.0)
LTDEF(0x27, LTPARAMS_ACCEL_CALIB_B2, LTPARAMS_TYPE_FLOAT, f, 0.0)
LTDEF(0x28, LTPARAMS_ACCEL_CALIB_M00, LTPARAMS_TYPE_FLOAT, f, 9.80665)
...
LTDEF(0x2c, LTPARAMS_ACCEL_CALIB_M11, LTPARAMS_TYPE_FLOAT, f, 9.80665)
...
LTDEF(0x30, LTPARAMS_ACCEL_CALIB_M22, LTPARAMS_TYPE_FLOAT, f, 9.80665)